...
pub type R = crate::R<ClkRtcHmsCalSpec>;
#[doc = "Register `clk_rtc_hms_cal` writer"]
pub type W = crate::W<ClkRtcHmsCalSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkRtcHmsCalSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkRtcHmsCalSpec;
impl crate::RegisterSpec for ClkRtcHmsCalSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_rtc_hms_cal::R`](R) reader structure"]
impl crate::Readable for ClkRtcHmsCalSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_rtc_hms_cal::W`](W) writer structure"]
impl crate::Writable for ClkRtcHmsCalSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_rtc_hms_cal to value 0"]
impl crate::Resettable for ClkRtcHmsCalSpec {
