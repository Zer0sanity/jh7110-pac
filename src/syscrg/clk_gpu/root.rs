...
#[repr(u8)]
pub enum ClkMuxSel {
    #[doc = "0: Select `clk_pll2` as the GPU Root clock."]
    ClkPll2 = 0,
    #[doc = "1: Select `clk_pll1` as the GPU Root clock."]
    ClkPll1 = 1,
}
...
impl ClkMuxSelR {
    ...
    #[doc = "Select `clk_pll2` as the GPU Root clock."]
    #[inline(always)]
    pub fn is_clk_pll2(&self) -> bool {
        *self == ClkMuxSel::ClkPll2
    }
    #[doc = "Select `clk_pll1` as the GPU Root clock."]
    #[inline(always)]
