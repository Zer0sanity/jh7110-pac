#[doc = "Register `clk_dvp_inv` reader"]
pub type R = crate::R<ClkDvpInvSpec>;
#[doc = "Register `clk_dvp_inv` writer"]
pub type W = crate::W<ClkDvpInvSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_polarity(&mut self) -> ClkPolarityW<ClkDvpInvSpec> {
        ClkPolarityW::new(self, 30)
    }
}
#[doc = "Clock DVP Inverter\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clk_dvp_inv::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clk_dvp_inv::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkDvpInvSpec;
impl crate::RegisterSpec for ClkDvpInvSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_dvp_inv::R`](R) reader structure"]
impl crate::Readable for ClkDvpInvSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_dvp_inv::W`](W) writer structure"]
impl crate::Writable for ClkDvpInvSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_dvp_inv to value 0x4000_0000"]
impl crate::Resettable for ClkDvpInvSpec {
