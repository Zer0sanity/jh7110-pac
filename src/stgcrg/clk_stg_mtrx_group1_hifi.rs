#[doc = "Register `clk_stg_mtrx_group1_hifi` reader"]
pub type R = crate::R<ClkStgMtrxGroup1HifiSpec>;
#[doc = "Register `clk_stg_mtrx_group1_hifi` writer"]
pub type W = crate::W<ClkStgMtrxGroup1HifiSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkStgMtrxGroup1HifiSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkStgMtrxGroup1HifiSpec;
impl crate::RegisterSpec for ClkStgMtrxGroup1HifiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_stg_mtrx_group1_hifi::R`](R) reader structure"]
impl crate::Readable for ClkStgMtrxGroup1HifiSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_stg_mtrx_group1_hifi::W`](W) writer structure"]
impl crate::Writable for ClkStgMtrxGroup1HifiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_stg_mtrx_group1_hifi to value 0"]
impl crate::Resettable for ClkStgMtrxGroup1HifiSpec {
