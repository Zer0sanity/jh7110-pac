...
#[doc = "Field `clk_divcfg` reader - Clock divider coefficient: Max=4, Default=2, Min=2, Typical=2"]
pub type ClkDivcfgR = crate::FieldReader<u32>;
#[doc = "Field `clk_divcfg` writer - Clock divider coefficient: Max=4, Default=2, Min=2, Typical=2"]
pub type ClkDivcfgW<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bits 0:23 - Clock divider coefficient: Max=4, Default=2, Min=2, Typical=2"]
    #[inline(always)]
...
#[doc = "`reset()` method sets axi to value 0x02"]
