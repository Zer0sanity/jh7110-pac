...
pub type R = crate::R<Gpio55Spec>;
#[doc = "Register `gpio55` writer"]
pub type W = crate::W<Gpio55Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ie(&mut self) -> IeW<Gpio55Spec> {
        IeW::new(self, 0)
    }
    #[doc = "Bits 1:2 - Output Drive Strength (DS) - 00: The rated drive strength is 2 mA, 01: The rated drive strength is 4 mA, 10: The rated drive strength is 8 mA, 11: The rated drive strength is 12 mA"]
    #[inline(always)]
    #[must_use]
    pub fn ds(&mut self) -> DsW<Gpio55Spec> {
        DsW::new(self, 1)
    }
    #[doc = "Bit 3 - Pull-Up (PU) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn pu(&mut self) -> PuW<Gpio55Spec> {
        PuW::new(self, 3)
    }
    #[doc = "Bit 4 - Pull-Down (PD) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn pd(&mut self) -> PdW<Gpio55Spec> {
        PdW::new(self, 4)
    }
    #[doc = "Bit 5 - Slew Rate Control - 0: Slow (Half frequency), 1: Fast"]
    #[inline(always)]
    #[must_use]
    pub fn slew(&mut self) -> SlewW<Gpio55Spec> {
        SlewW::new(self, 5)
    }
    #[doc = "Bit 6 - Active high Schmitt (SMT) trigger selector - 0: No hysteresis, 1: Schmitt trigger ebabled"]
    #[inline(always)]
    #[must_use]
    pub fn smt(&mut self) -> SmtW<Gpio55Spec> {
        SmtW::new(self, 6)
    }
    #[doc = "Bit 7 - Power-on-Start (POS) enabler - 1: Enable active pull down for loss of core power, 0: Active pull-down capability disabled"]
    #[inline(always)]
    #[must_use]
    pub fn pos(&mut self) -> PosW<Gpio55Spec> {
        PosW::new(self, 7)
    }
}
...
pub struct Gpio55Spec;
impl crate::RegisterSpec for Gpio55Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio55::R`](R) reader structure"]
impl crate::Readable for Gpio55Spec {}
#[doc = "`write(|w| ..)` method takes [`gpio55::W`](W) writer structure"]
impl crate::Writable for Gpio55Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets gpio55 to value 0x01"]
impl crate::Resettable for Gpio55Spec {
