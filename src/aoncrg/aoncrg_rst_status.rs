...
pub type R = crate::R<AoncrgRstStatusSpec>;
#[doc = "Register `aoncrg_rst_status` writer"]
pub type W = crate::W<AoncrgRstStatusSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gmac5_axi64_axi(&mut self) -> Gmac5Axi64AxiW<AoncrgRstStatusSpec> {
        Gmac5Axi64AxiW::new(self, 0)
    }
    #[doc = "Bit 1 - GMAC5 AXI64 AHB reset."]
    #[inline(always)]
    #[must_use]
    pub fn gmac5_axi64_ahb(&mut self) -> Gmac5Axi64AhbW<AoncrgRstStatusSpec> {
        Gmac5Axi64AhbW::new(self, 1)
    }
    #[doc = "Bit 2 - AON IOMUX Presetn reset."]
    #[inline(always)]
    #[must_use]
    pub fn aon_iomux_presetn(&mut self) -> AonIomuxPresetnW<AoncrgRstStatusSpec> {
        AonIomuxPresetnW::new(self, 2)
    }
    #[doc = "Bit 3 - PMU APB reset."]
    #[inline(always)]
    #[must_use]
    pub fn pmu_apb(&mut self) -> PmuApbW<AoncrgRstStatusSpec> {
        PmuApbW::new(self, 3)
    }
    #[doc = "Bit 4 - PMU Wake-up reset."]
    #[inline(always)]
    #[must_use]
    pub fn pmu_wkup(&mut self) -> PmuWkupW<AoncrgRstStatusSpec> {
        PmuWkupW::new(self, 4)
    }
    #[doc = "Bit 5 - RTC HMS APB reset."]
    #[inline(always)]
    #[must_use]
    pub fn rtc_hms_apb(&mut self) -> RtcHmsApbW<AoncrgRstStatusSpec> {
        RtcHmsApbW::new(self, 5)
    }
    #[doc = "Bit 6 - RTC HMS CAL reset."]
    #[inline(always)]
    #[must_use]
    pub fn rtc_hms_cal(&mut self) -> RtcHmsCalW<AoncrgRstStatusSpec> {
        RtcHmsCalW::new(self, 6)
    }
    #[doc = "Bit 7 - RTC HMS Oscillator 32k reset."]
    #[inline(always)]
    #[must_use]
    pub fn rtc_hms_osc32k(&mut self) -> RtcHmsOsc32kW<AoncrgRstStatusSpec> {
...
pub struct AoncrgRstStatusSpec;
impl crate::RegisterSpec for AoncrgRstStatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aoncrg_rst_status::R`](R) reader structure"]
impl crate::Readable for AoncrgRstStatusSpec {}
#[doc = "`write(|w| ..)` method takes [`aoncrg_rst_status::W`](W) writer structure"]
impl crate::Writable for AoncrgRstStatusSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets aoncrg_rst_status to value 0xe3"]
impl crate::Resettable for AoncrgRstStatusSpec {
