...
pub type R = crate::R<HardTurnOnPowerModeSpec>;
#[doc = "Register `hard_turn_on_power_mode` writer"]
pub type W = crate::W<HardTurnOnPowerModeSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn systop_power_mode(&mut self) -> SystopPowerModeW<HardTurnOnPowerModeSpec> {
        SystopPowerModeW::new(self, 0)
    }
    #[doc = "Bit 1 - CPU turn-on power mode"]
    #[inline(always)]
    #[must_use]
    pub fn cpu_power_mode(&mut self) -> CpuPowerModeW<HardTurnOnPowerModeSpec> {
        CpuPowerModeW::new(self, 1)
    }
    #[doc = "Bit 2 - GPUA turn-on power mode"]
    #[inline(always)]
    #[must_use]
    pub fn gpua_power_mode(&mut self) -> GpuaPowerModeW<HardTurnOnPowerModeSpec> {
        GpuaPowerModeW::new(self, 2)
    }
    #[doc = "Bit 3 - VDEC turn-on power mode"]
    #[inline(always)]
    #[must_use]
    pub fn vdec_power_mode(&mut self) -> VdecPowerModeW<HardTurnOnPowerModeSpec> {
        VdecPowerModeW::new(self, 3)
    }
    #[doc = "Bit 4 - VOUT turn-on power mode"]
    #[inline(always)]
    #[must_use]
    pub fn vout_power_mode(&mut self) -> VoutPowerModeW<HardTurnOnPowerModeSpec> {
        VoutPowerModeW::new(self, 4)
    }
    #[doc = "Bit 5 - ISP turn-on power mode"]
    #[inline(always)]
    #[must_use]
    pub fn isp_power_mode(&mut self) -> IspPowerModeW<HardTurnOnPowerModeSpec> {
        IspPowerModeW::new(self, 5)
    }
    #[doc = "Bit 6 - VENC turn-on power mode"]
    #[inline(always)]
    #[must_use]
    pub fn venc_power_mode(&mut self) -> VencPowerModeW<HardTurnOnPowerModeSpec> {
...
pub struct HardTurnOnPowerModeSpec;
impl crate::RegisterSpec for HardTurnOnPowerModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hard_turn_on_power_mode::R`](R) reader structure"]
impl crate::Readable for HardTurnOnPowerModeSpec {}
#[doc = "`write(|w| ..)` method takes [`hard_turn_on_power_mode::W`](W) writer structure"]
impl crate::Writable for HardTurnOnPowerModeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets hard_turn_on_power_mode to value 0"]
impl crate::Resettable for HardTurnOnPowerModeSpec {
