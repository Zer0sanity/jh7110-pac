#[doc = "Register `clk_e2_core` reader"]
pub type R = crate::R<ClkE2CoreSpec>;
#[doc = "Register `clk_e2_core` writer"]
pub type W = crate::W<ClkE2CoreSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkE2CoreSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkE2CoreSpec;
impl crate::RegisterSpec for ClkE2CoreSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_e2_core::R`](R) reader structure"]
impl crate::Readable for ClkE2CoreSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_e2_core::W`](W) writer structure"]
impl crate::Writable for ClkE2CoreSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_e2_core to value 0x01"]
impl crate::Resettable for ClkE2CoreSpec {
