#[doc = "Register `clk_noc_stg_axi` reader"]
pub type R = crate::R<ClkNocStgAxiSpec>;
#[doc = "Register `clk_noc_stg_axi` writer"]
pub type W = crate::W<ClkNocStgAxiSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkNocStgAxiSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkNocStgAxiSpec;
impl crate::RegisterSpec for ClkNocStgAxiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_noc_stg_axi::R`](R) reader structure"]
impl crate::Readable for ClkNocStgAxiSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_noc_stg_axi::W`](W) writer structure"]
impl crate::Writable for ClkNocStgAxiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_noc_stg_axi to value 0"]
impl crate::Resettable for ClkNocStgAxiSpec {
