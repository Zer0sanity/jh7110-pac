#[doc = "Register `clk_sec_hclk` reader"]
pub type R = crate::R<ClkSecHclkSpec>;
#[doc = "Register `clk_sec_hclk` writer"]
pub type W = crate::W<ClkSecHclkSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkSecHclkSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkSecHclkSpec;
impl crate::RegisterSpec for ClkSecHclkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_sec_hclk::R`](R) reader structure"]
impl crate::Readable for ClkSecHclkSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_sec_hclk::W`](W) writer structure"]
impl crate::Writable for ClkSecHclkSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_sec_hclk to value 0"]
impl crate::Resettable for ClkSecHclkSpec {
