...
pub type R = crate::R<ClkAxiGmac5Spec>;
#[doc = "Register `clk_axi_gmac5` writer"]
pub type W = crate::W<ClkAxiGmac5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkAxiGmac5Spec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkAxiGmac5Spec;
impl crate::RegisterSpec for ClkAxiGmac5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_axi_gmac5::R`](R) reader structure"]
impl crate::Readable for ClkAxiGmac5Spec {}
#[doc = "`write(|w| ..)` method takes [`clk_axi_gmac5::W`](W) writer structure"]
impl crate::Writable for ClkAxiGmac5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_axi_gmac5 to value 0"]
impl crate::Resettable for ClkAxiGmac5Spec {
