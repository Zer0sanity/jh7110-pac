...
pub type W = crate::W<ClrIntrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_under(&mut self) -> RxUnderW<ClrIntrSpec> {
        RxUnderW::new(self, 0)
    }
    #[doc = "Bit 1 - RX FIFO Overrun"]
    #[inline(always)]
    #[must_use]
    pub fn rx_over(&mut self) -> RxOverW<ClrIntrSpec> {
        RxOverW::new(self, 1)
    }
    #[doc = "Bit 2 - RX FIFO Full"]
    #[inline(always)]
    #[must_use]
    pub fn rx_full(&mut self) -> RxFullW<ClrIntrSpec> {
        RxFullW::new(self, 2)
    }
    #[doc = "Bit 3 - TX FIFO Overrun"]
    #[inline(always)]
    #[must_use]
    pub fn tx_over(&mut self) -> TxOverW<ClrIntrSpec> {
        TxOverW::new(self, 3)
    }
    #[doc = "Bit 4 - TX FIFO Empty"]
    #[inline(always)]
    #[must_use]
    pub fn tx_empty(&mut self) -> TxEmptyW<ClrIntrSpec> {
        TxEmptyW::new(self, 4)
    }
    #[doc = "Bit 5 - Read Request"]
    #[inline(always)]
    #[must_use]
    pub fn rd_req(&mut self) -> RdReqW<ClrIntrSpec> {
        RdReqW::new(self, 5)
    }
    #[doc = "Bit 6 - TX Abort"]
    #[inline(always)]
    #[must_use]
    pub fn tx_abrt(&mut self) -> TxAbrtW<ClrIntrSpec> {
        TxAbrtW::new(self, 6)
    }
    #[doc = "Bit 7 - RX Done"]
    #[inline(always)]
    #[must_use]
    pub fn rx_done(&mut self) -> RxDoneW<ClrIntrSpec> {
        RxDoneW::new(self, 7)
    }
    #[doc = "Bit 8 - Activity"]
    #[inline(always)]
    #[must_use]
    pub fn activity(&mut self) -> ActivityW<ClrIntrSpec> {
        ActivityW::new(self, 8)
    }
    #[doc = "Bit 9 - Stop DET"]
    #[inline(always)]
    #[must_use]
    pub fn stop_det(&mut self) -> StopDetW<ClrIntrSpec> {
        StopDetW::new(self, 9)
    }
    #[doc = "Bit 10 - Start DET"]
    #[inline(always)]
    #[must_use]
    pub fn start_det(&mut self) -> StartDetW<ClrIntrSpec> {
        StartDetW::new(self, 10)
    }
    #[doc = "Bit 11 - General Call"]
    #[inline(always)]
    #[must_use]
    pub fn gen_call(&mut self) -> GenCallW<ClrIntrSpec> {
        GenCallW::new(self, 11)
    }
    #[doc = "Bit 12 - Restart DET"]
    #[inline(always)]
    #[must_use]
    pub fn restart_det(&mut self) -> RestartDetW<ClrIntrSpec> {
        RestartDetW::new(self, 12)
    }
    #[doc = "Bit 13 - Master on Hold"]
    #[inline(always)]
    #[must_use]
    pub fn mst_on_hold(&mut self) -> MstOnHoldW<ClrIntrSpec> {
...
impl crate::Writable for ClrIntrSpec {
