#[doc = "Register `sd0_data6` reader"]
pub type R = crate::R<Sd0Data6Spec>;
#[doc = "Register `sd0_data6` writer"]
pub type W = crate::W<Sd0Data6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ie(&mut self) -> IeW<Sd0Data6Spec> {
        IeW::new(self, 0)
    }
    #[doc = "Bits 1:2 - Output Drive Strength (DS) - 00: The rated drive strength is 2 mA, 01: The rated drive strength is 4 mA, 10: The rated drive strength is 8 mA, 11: The rated drive strength is 12 mA"]
    #[inline(always)]
    #[must_use]
    pub fn ds(&mut self) -> DsW<Sd0Data6Spec> {
        DsW::new(self, 1)
    }
    #[doc = "Bit 3 - Pull-Up (PU) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn pu(&mut self) -> PuW<Sd0Data6Spec> {
        PuW::new(self, 3)
    }
    #[doc = "Bit 4 - Pull-Down (PD) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn pd(&mut self) -> PdW<Sd0Data6Spec> {
        PdW::new(self, 4)
    }
    #[doc = "Bit 5 - Slew Rate Control - 0: Slow (Half frequency), 1: Fast"]
    #[inline(always)]
    #[must_use]
    pub fn slew(&mut self) -> SlewW<Sd0Data6Spec> {
        SlewW::new(self, 5)
    }
    #[doc = "Bit 6 - Active high Schmitt (SMT) trigger selector - 0: No hysteresis, 1: Schmitt trigger ebabled"]
    #[inline(always)]
    #[must_use]
    pub fn smt(&mut self) -> SmtW<Sd0Data6Spec> {
        SmtW::new(self, 6)
    }
    #[doc = "Bit 7 - Power-on-Start (POS) enabler - 1: Enable active pull down for loss of core power, 0: Active pull-down capability disabled"]
    #[inline(always)]
    #[must_use]
    pub fn pos(&mut self) -> PosW<Sd0Data6Spec> {
        PosW::new(self, 7)
    }
}
#[doc = "SYS IOMUX CFG SAIF SYSCFG PADCFG 576: SD0_DATA6\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sd0_data6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sd0_data6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sd0Data6Spec;
impl crate::RegisterSpec for Sd0Data6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sd0_data6::R`](R) reader structure"]
impl crate::Readable for Sd0Data6Spec {}
#[doc = "`write(|w| ..)` method takes [`sd0_data6::W`](W) writer structure"]
impl crate::Writable for Sd0Data6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets sd0_data6 to value 0x01"]
impl crate::Resettable for Sd0Data6Spec {
