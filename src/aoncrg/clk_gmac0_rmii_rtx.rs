...
pub type R = crate::R<ClkGmac0RmiiRtxSpec>;
#[doc = "Register `clk_gmac0_rmii_rtx` writer"]
pub type W = crate::W<ClkGmac0RmiiRtxSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> ClkDivcfgW<ClkGmac0RmiiRtxSpec> {
...
pub struct ClkGmac0RmiiRtxSpec;
impl crate::RegisterSpec for ClkGmac0RmiiRtxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_gmac0_rmii_rtx::R`](R) reader structure"]
impl crate::Readable for ClkGmac0RmiiRtxSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_gmac0_rmii_rtx::W`](W) writer structure"]
impl crate::Writable for ClkGmac0RmiiRtxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_gmac0_rmii_rtx to value 0x02"]
impl crate::Resettable for ClkGmac0RmiiRtxSpec {
