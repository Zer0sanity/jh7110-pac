#[doc = "Register `status_enable` reader"]
pub type R = crate::R<StatusEnableSpec>;
#[doc = "Register `status_enable` writer"]
pub type W = crate::W<StatusEnableSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn blk_tr_done(&mut self) -> BlkTrDoneW<StatusEnableSpec> {
        BlkTrDoneW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel DMA Transfer Done - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn dma_tr_done(&mut self) -> DmaTrDoneW<StatusEnableSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn transcomp(&mut self, n: u8) -> TranscompW<StatusEnableSpec> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn transcomp_src(&mut self) -> TranscompW<StatusEnableSpec> {
        TranscompW::new(self, 3)
    }
    #[doc = "Bit 4 - Channel Transfer Complete - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn transcomp_dst(&mut self) -> TranscompW<StatusEnableSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dec_err(&mut self, n: u8) -> DecErrW<StatusEnableSpec> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn dec_err_src(&mut self) -> DecErrW<StatusEnableSpec> {
        DecErrW::new(self, 5)
    }
    #[doc = "Bit 6 - Channel Decoding Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn dec_err_dst(&mut self) -> DecErrW<StatusEnableSpec> {
        DecErrW::new(self, 6)
    }
    #[doc = "Channel Slave Error - 0: disabled, 1: enabled"]
    #[doc = ""]
    ...
    #[inline(always)]
    #[must_use]
    pub fn slv_err(&mut self, n: u8) -> SlvErrW<StatusEnableSpec> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn slv_err_src(&mut self) -> SlvErrW<StatusEnableSpec> {
        SlvErrW::new(self, 7)
    }
    #[doc = "Bit 8 - Channel Slave Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn slv_err_dst(&mut self) -> SlvErrW<StatusEnableSpec> {
        SlvErrW::new(self, 8)
    }
    #[doc = "Channel Linked List Item Decoding Error - 0: disabled, 1: enabled"]
    #[doc = ""]
    ...
    #[inline(always)]
    #[must_use]
    pub fn lli_dec_err(&mut self, n: u8) -> LliDecErrW<StatusEnableSpec> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn lli_dec_err_rd(&mut self) -> LliDecErrW<StatusEnableSpec> {
        LliDecErrW::new(self, 9)
    }
    #[doc = "Bit 10 - Channel Linked List Item Decoding Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn lli_dec_err_wr(&mut self) -> LliDecErrW<StatusEnableSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lli_slv_err(&mut self, n: u8) -> LliSlvErrW<StatusEnableSpec> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn lli_slv_err_rd(&mut self) -> LliSlvErrW<StatusEnableSpec> {
        LliSlvErrW::new(self, 11)
    }
    #[doc = "Bit 12 - Channel Linked List Item Slave Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn lli_slv_err_wr(&mut self) -> LliSlvErrW<StatusEnableSpec> {
        LliSlvErrW::new(self, 12)
    }
    #[doc = "Bit 13 - Channel Shadow Register or Linked List Item Invalid Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn shadow_or_invalid_lli_err(&mut self) -> ShadowOrInvalidLliErrW<StatusEnableSpec> {
        ShadowOrInvalidLliErrW::new(self, 13)
    }
    #[doc = "Bit 14 - Channel Slave Interface Multi Block Type Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_multiblktype_err(&mut self) -> SlvifMultiblktypeErrW<StatusEnableSpec> {
        SlvifMultiblktypeErrW::new(self, 14)
    }
    #[doc = "Bit 16 - Channel Slave Interface Decoding Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_dec_err(&mut self) -> SlvifDecErrW<StatusEnableSpec> {
        SlvifDecErrW::new(self, 16)
    }
    #[doc = "Bit 17 - Channel Slave Interface Write to Read-only Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_wr2ro_err(&mut self) -> SlvifWr2roErrW<StatusEnableSpec> {
        SlvifWr2roErrW::new(self, 17)
    }
    #[doc = "Bit 18 - Channel Slave Interface Read to Write-only Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_r2wro_err(&mut self) -> SlvifR2wroErrW<StatusEnableSpec> {
        SlvifR2wroErrW::new(self, 18)
    }
    #[doc = "Bit 19 - Channel Slave Interface Write On Channel Enabled Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_wronchen_err(&mut self) -> SlvifWronchenErrW<StatusEnableSpec> {
        SlvifWronchenErrW::new(self, 19)
    }
    #[doc = "Bit 20 - Channel Slave Interface Shadow Register Write On Valid Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_shadow_wron_valid_err(&mut self) -> SlvifShadowWronValidErrW<StatusEnableSpec> {
        SlvifShadowWronValidErrW::new(self, 20)
    }
    #[doc = "Bit 21 - Channel Slave Interface Write On Hold Error - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn slvif_wron_hold_err(&mut self) -> SlvifWronHoldErrW<StatusEnableSpec> {
        SlvifWronHoldErrW::new(self, 21)
    }
    #[doc = "Bit 27 - Channel Lock Cleared - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn ch_lock_cleared(&mut self) -> ChLockClearedW<StatusEnableSpec> {
        ChLockClearedW::new(self, 27)
    }
    #[doc = "Bit 28 - Channel Source Suspended - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn ch_src_suspended(&mut self) -> ChSrcSuspendedW<StatusEnableSpec> {
        ChSrcSuspendedW::new(self, 28)
    }
    #[doc = "Bit 29 - Channel Suspended - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn ch_suspended(&mut self) -> ChSuspendedW<StatusEnableSpec> {
        ChSuspendedW::new(self, 29)
    }
    #[doc = "Bit 30 - Channel Disabled - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn ch_disabled(&mut self) -> ChDisabledW<StatusEnableSpec> {
        ChDisabledW::new(self, 30)
    }
    #[doc = "Bit 31 - Channel Aborted - 0: disabled, 1: enabled"]
    #[inline(always)]
    #[must_use]
    pub fn ch_aborted(&mut self) -> ChAbortedW<StatusEnableSpec> {
        ChAbortedW::new(self, 31)
    }
}
#[doc = "Channel Interrupt Status Enable\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`status_enable::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`status_enable::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct StatusEnableSpec;
impl crate::RegisterSpec for StatusEnableSpec {
    type Ux = u64;
}
#[doc = "`read()` method returns [`status_enable::R`](R) reader structure"]
impl crate::Readable for StatusEnableSpec {}
#[doc = "`write(|w| ..)` method takes [`status_enable::W`](W) writer structure"]
impl crate::Writable for StatusEnableSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u64 = 0;
}
#[doc = "`reset()` method sets status_enable to value 0xffff_ffff_ffff_ffff"]
impl crate::Resettable for StatusEnableSpec {
