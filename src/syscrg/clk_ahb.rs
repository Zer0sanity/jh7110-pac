#[doc = "Register `clk_ahb[%s]` reader"]
pub type R = crate::R<ClkAhbSpec>;
#[doc = "Register `clk_ahb[%s]` writer"]
pub type W = crate::W<ClkAhbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkAhbSpec> {
        ClkIcgW::new(self, 31)
    }
}
#[doc = "Clock AHB\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clk_ahb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clk_ahb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ClkAhbSpec;
impl crate::RegisterSpec for ClkAhbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_ahb::R`](R) reader structure"]
impl crate::Readable for ClkAhbSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_ahb::W`](W) writer structure"]
impl crate::Writable for ClkAhbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_ahb[%s]
to value 0x8000_0000"]
impl crate::Resettable for ClkAhbSpec {
