#[doc = "Register `clk_gclk2` reader"]
pub type R = crate::R<ClkGclk2Spec>;
#[doc = "Register `clk_gclk2` writer"]
pub type W = crate::W<ClkGclk2Spec>;
#[doc = "Field `clk_divcfg` reader - Clock divider coefficient: Max=62, Default=12, Min=12, Typical=12"]
pub type ClkDivcfgR = crate::FieldReader<u32>;
#[doc = "Field `clk_divcfg` writer - Clock divider coefficient: Max=62, Default=12, Min=12, Typical=12"]
...
impl R {
    #[doc = "Bits 0:23 - Clock divider coefficient: Max=62, Default=12, Min=12, Typical=12"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> ClkDivcfgW<ClkGclk2Spec> {
        ClkDivcfgW::new(self, 0)
    }
    #[doc = "Bit 31 - Clock ICG enable."]
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkGclk2Spec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkGclk2Spec;
impl crate::RegisterSpec for ClkGclk2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_gclk2::R`](R) reader structure"]
impl crate::Readable for ClkGclk2Spec {}
#[doc = "`write(|w| ..)` method takes [`clk_gclk2::W`](W) writer structure"]
impl crate::Writable for ClkGclk2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_gclk2 to value 0x8000_000c"]
impl crate::Resettable for ClkGclk2Spec {
    const RESET_VALUE: u32 = 0x8000_000c;
}
