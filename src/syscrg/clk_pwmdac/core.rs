...
#[doc = "Field `clk_divcfg` reader - Clock divider coefficient: Max=256, Default=12, Min=12, Typical=12"]
pub type ClkDivcfgR = crate::FieldReader<u32>;
#[doc = "Field `clk_divcfg` writer - Clock divider coefficient: Max=256, Default=12, Min=12, Typical=12"]
...
impl R {
    #[doc = "Bits 0:23 - Clock divider coefficient: Max=256, Default=12, Min=12, Typical=12"]
    #[inline(always)]
...
#[doc = "`reset()` method sets core to value 0x0c"]
