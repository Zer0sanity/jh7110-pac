...
#[doc = "Clock multiplexing selector: clk_osc, clk_pll0\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum ClkMuxSel {
    #[doc = "0: Select `clk_osc` as the CPU Root clock."]
    ClkOsc = 0,
    #[doc = "1: Select `clk_pll0` as the CPU Root clock."]
    ClkPll0 = 1,
}
...
impl ClkMuxSelR {
    ...
    pub const fn variant(&self) -> Option<ClkMuxSel> {
        match self.bits {
            ...
            1 => Some(ClkMuxSel::ClkPll0),
            _ => None,
        }
    }
    #[doc = "Select `clk_osc` as the CPU Root clock."]
    #[inline(always)]
    pub fn is_clk_osc(&self) -> bool {
        *self == ClkMuxSel::ClkOsc
    }
    #[doc = "Select `clk_pll0` as the CPU Root clock."]
    #[inline(always)]
    pub fn is_clk_pll0(&self) -> bool {
        *self == ClkMuxSel::ClkPll0
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Select `clk_pll0` as the CPU Root clock."]
    #[inline(always)]
    pub fn clk_pll0(self) -> &'a mut crate::W<REG> {
        self.variant(ClkMuxSel::ClkPll0)
    }
}
impl R {
