#[doc = "Register `apb[%s]` reader"]
pub type R = crate::R<ApbSpec>;
#[doc = "Register `apb[%s]` writer"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ApbSpec> {
        ClkIcgW::new(self, 31)
    }
}
#[doc = "Clock SPI APB\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ApbSpec;
