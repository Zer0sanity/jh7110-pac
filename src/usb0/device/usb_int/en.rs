...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn con(&mut self) -> ConW<EnSpec> {
        ConW::new(self, 0)
    }
    #[doc = "Bit 1 - SS disconnection interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn dis(&mut self) -> DisW<EnSpec> {
        DisW::new(self, 1)
    }
    #[doc = "Bit 2 - SS warm reset interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn uwres(&mut self) -> UwresW<EnSpec> {
        UwresW::new(self, 2)
    }
    #[doc = "Bit 3 - SS hot reset interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn uhres(&mut self) -> UhresW<EnSpec> {
        UhresW::new(self, 3)
    }
    #[doc = "Bit 4 - SS link U3 state enter interrupt - suspend."]
    #[inline(always)]
    #[must_use]
    pub fn u3ent(&mut self) -> U3entW<EnSpec> {
        U3entW::new(self, 4)
    }
    #[doc = "Bit 5 - SS link U3 state exit interrupt - wakeup."]
    #[inline(always)]
    #[must_use]
    pub fn u3ext(&mut self) -> U3extW<EnSpec> {
        U3extW::new(self, 5)
    }
    #[doc = "Bit 6 - SS link U2 state enter interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn u2ent(&mut self) -> U2entW<EnSpec> {
        U2entW::new(self, 6)
    }
    #[doc = "Bit 7 - SS link U2 state exit interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn u2ext(&mut self) -> U2extW<EnSpec> {
        U2extW::new(self, 7)
    }
    #[doc = "Bit 8 - SS link U1 state enter interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn u1ent(&mut self) -> U1entW<EnSpec> {
        U1entW::new(self, 8)
    }
    #[doc = "Bit 9 - SS link U1 state exit interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn u1ext(&mut self) -> U1extW<EnSpec> {
        U1extW::new(self, 9)
    }
    #[doc = "Bit 10 - ITP/SOF packet detected interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn itp(&mut self) -> ItpW<EnSpec> {
        ItpW::new(self, 10)
    }
    #[doc = "Bit 11 - Wakeup interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn wake(&mut self) -> WakeW<EnSpec> {
        WakeW::new(self, 11)
    }
    #[doc = "Bit 12 - Send Custom Packet interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spkt(&mut self) -> SpktW<EnSpec> {
        SpktW::new(self, 12)
    }
    #[doc = "Bit 16 - FS/HS mode connection interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn con2(&mut self) -> Con2W<EnSpec> {
        Con2W::new(self, 16)
    }
    #[doc = "Bit 17 - FS/HS mode disconnection interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn dis2(&mut self) -> Dis2W<EnSpec> {
        Dis2W::new(self, 17)
    }
    #[doc = "Bit 18 - USB reset interrupt - FS/HS mode."]
    #[inline(always)]
    #[must_use]
    pub fn u2res(&mut self) -> U2resW<EnSpec> {
        U2resW::new(self, 18)
    }
    #[doc = "Bit 20 - LPM L2 state enter interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn l2ent(&mut self) -> L2entW<EnSpec> {
        L2entW::new(self, 20)
    }
    #[doc = "Bit 21 - LPM L2 state exit interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn l2ext(&mut self) -> L2extW<EnSpec> {
        L2extW::new(self, 21)
    }
    #[doc = "Bit 24 - LPM L1 state enter interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn l1ent(&mut self) -> L1entW<EnSpec> {
        L1entW::new(self, 24)
    }
    #[doc = "Bit 25 - LPM L1 state exit interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn l1ext(&mut self) -> L1extW<EnSpec> {
        L1extW::new(self, 25)
    }
    #[doc = "Bit 26 - Configuration reset interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn cfgres(&mut self) -> CfgresW<EnSpec> {
        CfgresW::new(self, 26)
    }
    #[doc = "Bit 28 - Start of the USB SS warm reset interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn uwress(&mut self) -> UwressW<EnSpec> {
        UwressW::new(self, 28)
    }
    #[doc = "Bit 29 - End of the USB SS warm reset interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn uwrese(&mut self) -> UwreseW<EnSpec> {
        UwreseW::new(self, 29)
    }
}
...
#[doc = "`reset()` method sets en to value 0x0137_003f"]
impl crate::Resettable for EnSpec {
    const RESET_VALUE: u32 = 0x0137_003f;
}
