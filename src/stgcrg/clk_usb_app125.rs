#[doc = "Register `clk_usb_app125` reader"]
pub type R = crate::R<ClkUsbApp125Spec>;
#[doc = "Register `clk_usb_app125` writer"]
pub type W = crate::W<ClkUsbApp125Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkUsbApp125Spec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkUsbApp125Spec;
impl crate::RegisterSpec for ClkUsbApp125Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_usb_app125::R`](R) reader structure"]
impl crate::Readable for ClkUsbApp125Spec {}
#[doc = "`write(|w| ..)` method takes [`clk_usb_app125::W`](W) writer structure"]
impl crate::Writable for ClkUsbApp125Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_usb_app125 to value 0"]
impl crate::Resettable for ClkUsbApp125Spec {
