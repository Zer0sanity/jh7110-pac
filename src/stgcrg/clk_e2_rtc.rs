#[doc = "Register `clk_e2_rtc` reader"]
pub type R = crate::R<ClkE2RtcSpec>;
#[doc = "Register `clk_e2_rtc` writer"]
pub type W = crate::W<ClkE2RtcSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> ClkDivcfgW<ClkE2RtcSpec> {
        ClkDivcfgW::new(self, 0)
    }
    #[doc = "Bit 31 - Clock ICG enable."]
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkE2RtcSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkE2RtcSpec;
impl crate::RegisterSpec for ClkE2RtcSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_e2_rtc::R`](R) reader structure"]
impl crate::Readable for ClkE2RtcSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_e2_rtc::W`](W) writer structure"]
impl crate::Writable for ClkE2RtcSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_e2_rtc to value 0x18"]
impl crate::Resettable for ClkE2RtcSpec {
