#[doc = "Register `clk_apb0` reader"]
pub type R = crate::R<ClkApb0Spec>;
#[doc = "Register `clk_apb0` writer"]
pub type W = crate::W<ClkApb0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkApb0Spec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkApb0Spec;
impl crate::RegisterSpec for ClkApb0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_apb0::R`](R) reader structure"]
impl crate::Readable for ClkApb0Spec {}
#[doc = "`write(|w| ..)` method takes [`clk_apb0::W`](W) writer structure"]
impl crate::Writable for ClkApb0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_apb0 to value 0x8000_0000"]
impl crate::Resettable for ClkApb0Spec {
