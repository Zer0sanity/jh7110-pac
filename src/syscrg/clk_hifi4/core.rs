...
#[doc = "Field `clk_divcfg` reader - Clock divider coefficient: Max=15, Default=3, Min=3, Typical=3"]
pub type ClkDivcfgR = crate::FieldReader<u32>;
#[doc = "Field `clk_divcfg` writer - Clock divider coefficient: Max=15, Default=3, Min=3, Typical=3"]
pub type ClkDivcfgW<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bits 0:23 - Clock divider coefficient: Max=15, Default=3, Min=3, Typical=3"]
    #[inline(always)]
...
#[doc = "`reset()` method sets core to value 0x03"]
