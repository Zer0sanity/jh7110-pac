#[doc = "Register `clk_usb_axi` reader"]
pub type R = crate::R<ClkUsbAxiSpec>;
#[doc = "Register `clk_usb_axi` writer"]
pub type W = crate::W<ClkUsbAxiSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkUsbAxiSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkUsbAxiSpec;
impl crate::RegisterSpec for ClkUsbAxiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_usb_axi::R`](R) reader structure"]
impl crate::Readable for ClkUsbAxiSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_usb_axi::W`](W) writer structure"]
impl crate::Writable for ClkUsbAxiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_usb_axi to value 0"]
impl crate::Resettable for ClkUsbAxiSpec {
