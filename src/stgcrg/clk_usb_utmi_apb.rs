#[doc = "Register `clk_usb_utmi_apb` reader"]
pub type R = crate::R<ClkUsbUtmiApbSpec>;
#[doc = "Register `clk_usb_utmi_apb` writer"]
pub type W = crate::W<ClkUsbUtmiApbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkUsbUtmiApbSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkUsbUtmiApbSpec;
impl crate::RegisterSpec for ClkUsbUtmiApbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_usb_utmi_apb::R`](R) reader structure"]
impl crate::Readable for ClkUsbUtmiApbSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_usb_utmi_apb::W`](W) writer structure"]
impl crate::Writable for ClkUsbUtmiApbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_usb_utmi_apb to value 0"]
impl crate::Resettable for ClkUsbUtmiApbSpec {
