#[doc = "Register `clk_internal_ctrl_apb` reader"]
pub type R = crate::R<ClkInternalCtrlApbSpec>;
#[doc = "Register `clk_internal_ctrl_apb` writer"]
pub type W = crate::W<ClkInternalCtrlApbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkInternalCtrlApbSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkInternalCtrlApbSpec;
impl crate::RegisterSpec for ClkInternalCtrlApbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_internal_ctrl_apb::R`](R) reader structure"]
impl crate::Readable for ClkInternalCtrlApbSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_internal_ctrl_apb::W`](W) writer structure"]
impl crate::Writable for ClkInternalCtrlApbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_internal_ctrl_apb to value 0x8000_0000"]
impl crate::Resettable for ClkInternalCtrlApbSpec {
