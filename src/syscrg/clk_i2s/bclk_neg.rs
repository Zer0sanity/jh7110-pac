#[doc = "Register `bclk_neg` reader"]
pub type R = crate::R<BclkNegSpec>;
#[doc = "Register `bclk_neg` writer"]
pub type W = crate::W<BclkNegSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_polarity(&mut self) -> ClkPolarityW<BclkNegSpec> {
        ClkPolarityW::new(self, 30)
    }
}
#[doc = "Clock I2S BCLK Negative\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bclk_neg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bclk_neg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BclkNegSpec;
impl crate::RegisterSpec for BclkNegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bclk_neg::R`](R) reader structure"]
impl crate::Readable for BclkNegSpec {}
#[doc = "`write(|w| ..)` method takes [`bclk_neg::W`](W) writer structure"]
impl crate::Writable for BclkNegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets bclk_neg to value 0x4000_0000"]
impl crate::Resettable for BclkNegSpec {
