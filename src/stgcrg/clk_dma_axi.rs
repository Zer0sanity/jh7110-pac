#[doc = "Register `clk_dma_axi` reader"]
pub type R = crate::R<ClkDmaAxiSpec>;
#[doc = "Register `clk_dma_axi` writer"]
pub type W = crate::W<ClkDmaAxiSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkDmaAxiSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkDmaAxiSpec;
impl crate::RegisterSpec for ClkDmaAxiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_dma_axi::R`](R) reader structure"]
impl crate::Readable for ClkDmaAxiSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_dma_axi::W`](W) writer structure"]
impl crate::Writable for ClkDmaAxiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_dma_axi to value 0"]
impl crate::Resettable for ClkDmaAxiSpec {
