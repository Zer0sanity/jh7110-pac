#[doc = "Register `clk_dma_ahb` reader"]
pub type R = crate::R<ClkDmaAhbSpec>;
#[doc = "Register `clk_dma_ahb` writer"]
pub type W = crate::W<ClkDmaAhbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkDmaAhbSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkDmaAhbSpec;
impl crate::RegisterSpec for ClkDmaAhbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_dma_ahb::R`](R) reader structure"]
impl crate::Readable for ClkDmaAhbSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_dma_ahb::W`](W) writer structure"]
impl crate::Writable for ClkDmaAhbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_dma_ahb to value 0"]
impl crate::Resettable for ClkDmaAhbSpec {
