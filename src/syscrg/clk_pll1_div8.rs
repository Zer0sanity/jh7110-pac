...
pub type R = crate::R<ClkPll1Div8Spec>;
#[doc = "Register `clk_pll1_div8` writer"]
pub type W = crate::W<ClkPll1Div8Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> ClkDivcfgW<ClkPll1Div8Spec> {
...
pub struct ClkPll1Div8Spec;
impl crate::RegisterSpec for ClkPll1Div8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_pll1_div8::R`](R) reader structure"]
impl crate::Readable for ClkPll1Div8Spec {}
#[doc = "`write(|w| ..)` method takes [`clk_pll1_div8::W`](W) writer structure"]
impl crate::Writable for ClkPll1Div8Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_pll1_div8 to value 0x02"]
impl crate::Resettable for ClkPll1Div8Spec {
