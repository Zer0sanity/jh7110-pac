#[doc = "Register `clk_ahb_gmac5` reader"]
pub type R = crate::R<ClkAhbGmac5Spec>;
#[doc = "Register `clk_ahb_gmac5` writer"]
pub type W = crate::W<ClkAhbGmac5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkAhbGmac5Spec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkAhbGmac5Spec;
impl crate::RegisterSpec for ClkAhbGmac5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_ahb_gmac5::R`](R) reader structure"]
impl crate::Readable for ClkAhbGmac5Spec {}
#[doc = "`write(|w| ..)` method takes [`clk_ahb_gmac5::W`](W) writer structure"]
impl crate::Writable for ClkAhbGmac5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_ahb_gmac5 to value 0"]
impl crate::Resettable for ClkAhbGmac5Spec {
