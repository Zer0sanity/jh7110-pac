#[doc = "Register `clk_optc_apb` reader"]
pub type R = crate::R<ClkOptcApbSpec>;
#[doc = "Register `clk_optc_apb` writer"]
pub type W = crate::W<ClkOptcApbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkOptcApbSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkOptcApbSpec;
impl crate::RegisterSpec for ClkOptcApbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_optc_apb::R`](R) reader structure"]
impl crate::Readable for ClkOptcApbSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_optc_apb::W`](W) writer structure"]
impl crate::Writable for ClkOptcApbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_optc_apb to value 0x8000_0000"]
impl crate::Resettable for ClkOptcApbSpec {
