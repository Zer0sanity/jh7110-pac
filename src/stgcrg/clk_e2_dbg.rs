...
pub type R = crate::R<ClkE2DbgSpec>;
#[doc = "Register `clk_e2_dbg` writer"]
pub type W = crate::W<ClkE2DbgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkE2DbgSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkE2DbgSpec;
impl crate::RegisterSpec for ClkE2DbgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_e2_dbg::R`](R) reader structure"]
impl crate::Readable for ClkE2DbgSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_e2_dbg::W`](W) writer structure"]
impl crate::Writable for ClkE2DbgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_e2_dbg to value 0"]
impl crate::Resettable for ClkE2DbgSpec {
