...
impl Interrupt {
    ...
    pub fn try_from(value: u8) -> Result<Self, TryFromInterruptError> {
        match value {
            ...
            60 => Ok(Interrupt::PTC0),
            61 => Ok(Interrupt::PTC1),
            62 => Ok(Interrupt::PTC2),
            63 => Ok(Interrupt::PTC3),
            64 => Ok(Interrupt::PTC4),
            65 => Ok(Interrupt::PTC5),
            66 => Ok(Interrupt::PTC6),
            67 => Ok(Interrupt::PTC7),
            68 => Ok(Interrupt::WDOG),
            69 => Ok(Interrupt::TIMER0),
            70 => Ok(Interrupt::TIMER1),
            71 => Ok(Interrupt::TIMER2),
            72 => Ok(Interrupt::TIMER3),
            73 => Ok(Interrupt::DMA),
