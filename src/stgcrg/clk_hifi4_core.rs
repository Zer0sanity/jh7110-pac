#[doc = "Register `clk_hifi4_core` reader"]
pub type R = crate::R<ClkHifi4CoreSpec>;
#[doc = "Register `clk_hifi4_core` writer"]
pub type W = crate::W<ClkHifi4CoreSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkHifi4CoreSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkHifi4CoreSpec;
impl crate::RegisterSpec for ClkHifi4CoreSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_hifi4_core::R`](R) reader structure"]
impl crate::Readable for ClkHifi4CoreSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_hifi4_core::W`](W) writer structure"]
impl crate::Writable for ClkHifi4CoreSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_hifi4_core to value 0"]
impl crate::Resettable for ClkHifi4CoreSpec {
