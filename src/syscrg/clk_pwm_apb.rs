...
pub type R = crate::R<ClkPwmApbSpec>;
#[doc = "Register `clk_pwm_apb` writer"]
pub type W = crate::W<ClkPwmApbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkPwmApbSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkPwmApbSpec;
impl crate::RegisterSpec for ClkPwmApbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_pwm_apb::R`](R) reader structure"]
impl crate::Readable for ClkPwmApbSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_pwm_apb::W`](W) writer structure"]
impl crate::Writable for ClkPwmApbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_pwm_apb to value 0"]
impl crate::Resettable for ClkPwmApbSpec {
