#[doc = "Register `bclk_mst` reader"]
pub type R = crate::R<BclkMstSpec>;
#[doc = "Register `bclk_mst` writer"]
pub type W = crate::W<BclkMstSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> ClkDivcfgW<BclkMstSpec> {
        ClkDivcfgW::new(self, 0)
    }
    #[doc = "Bit 31 - Clock ICG enable."]
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<BclkMstSpec> {
        ClkIcgW::new(self, 31)
    }
}
#[doc = "Clock I2S BCLK MST\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bclk_mst::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bclk_mst::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BclkMstSpec;
impl crate::RegisterSpec for BclkMstSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bclk_mst::R`](R) reader structure"]
impl crate::Readable for BclkMstSpec {}
#[doc = "`write(|w| ..)` method takes [`bclk_mst::W`](W) writer structure"]
impl crate::Writable for BclkMstSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets bclk_mst to value 0x04"]
impl crate::Resettable for BclkMstSpec {
