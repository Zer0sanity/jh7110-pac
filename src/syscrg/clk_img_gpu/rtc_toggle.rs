...
#[doc = "Field `clk_divcfg` reader - Clock divider coefficient: Max=12, Default=12, Min=12, Typical=12"]
pub type ClkDivcfgR = crate::FieldReader<u32>;
#[doc = "Field `clk_divcfg` writer - Clock divider coefficient: Max=12, Default=12, Min=12, Typical=12"]
...
impl R {
    #[doc = "Bits 0:23 - Clock divider coefficient: Max=12, Default=12, Min=12, Typical=12"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<RtcToggleSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
#[doc = "`reset()` method sets rtc_toggle to value 0x0c"]
