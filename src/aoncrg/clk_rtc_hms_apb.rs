#[doc = "Register `clk_rtc_hms_apb` reader"]
pub type R = crate::R<ClkRtcHmsApbSpec>;
#[doc = "Register `clk_rtc_hms_apb` writer"]
pub type W = crate::W<ClkRtcHmsApbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<ClkRtcHmsApbSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
pub struct ClkRtcHmsApbSpec;
impl crate::RegisterSpec for ClkRtcHmsApbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`clk_rtc_hms_apb::R`](R) reader structure"]
impl crate::Readable for ClkRtcHmsApbSpec {}
#[doc = "`write(|w| ..)` method takes [`clk_rtc_hms_apb::W`](W) writer structure"]
impl crate::Writable for ClkRtcHmsApbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets clk_rtc_hms_apb to value 0x8000_0000"]
impl crate::Resettable for ClkRtcHmsApbSpec {
