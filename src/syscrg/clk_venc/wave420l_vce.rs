#[doc = "Register `wave420l_vce` reader"]
pub type R = crate::R<Wave420lVceSpec>;
#[doc = "Register `wave420l_vce` writer"]
pub type W = crate::W<Wave420lVceSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> ClkDivcfgW<Wave420lVceSpec> {
        ClkDivcfgW::new(self, 0)
    }
    #[doc = "Bit 31 - Clock ICG enable."]
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<Wave420lVceSpec> {
        ClkIcgW::new(self, 31)
    }
}
#[doc = "Clock WAVE420L VCE\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`wave420l_vce::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wave420l_vce::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Wave420lVceSpec;
impl crate::RegisterSpec for Wave420lVceSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wave420l_vce::R`](R) reader structure"]
impl crate::Readable for Wave420lVceSpec {}
#[doc = "`write(|w| ..)` method takes [`wave420l_vce::W`](W) writer structure"]
impl crate::Writable for Wave420lVceSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets wave420l_vce to value 0x05"]
impl crate::Resettable for Wave420lVceSpec {
