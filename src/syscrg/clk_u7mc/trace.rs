#[doc = "Register `trace[%s]` reader"]
pub type R = crate::R<TraceSpec>;
#[doc = "Register `trace[%s]` writer"]
pub type W = crate::W<TraceSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> ClkIcgW<TraceSpec> {
        ClkIcgW::new(self, 31)
    }
}
...
impl crate::RegisterSpec for TraceSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`trace::R`](R) reader structure"]
impl crate::Readable for TraceSpec {}
#[doc = "`write(|w| ..)` method takes [`trace::W`](W) writer structure"]
impl crate::Writable for TraceSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets trace[%s]
to value 0x8000_0000"]
impl crate::Resettable for TraceSpec {
